...
var session = conf.session.replace(/MR_ANDBAD-MD-WHATSAPP-BOT;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['MR_ANDBAD-MD', "safari", "1.0.0"],
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ MR_ANDBAD-MD is connecting...");
            }
                ...
                console.log("------------------/-----");
                console.log("MR_ANDBAD-MD is Online 🕸\n\n");
